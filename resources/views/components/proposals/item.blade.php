...
<div class="flex justify-between items-center">
    ...
    <div class="uppercase whitespace-nowrap font-bold text-[#C3C3D1] flex items-center space-x-2 px-2 py-1 rounded-full bg-[#181826] border border-[#1E1E2C] text-[12px]">
